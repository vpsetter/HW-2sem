...
public:
		...
		m_delay(100'000)
	{
		...
		client_player.direction = static_cast<Direction>(uid(dre));
	};
...
private:
	...
	void read_key()
	{
		if ((Keyboard::isKeyPressed(Keyboard::Left)) && (client_player.direction != Direction::right))
		{
			client_player.direction = Direction::left;
		}
		if ((Keyboard::isKeyPressed(Keyboard::Right)) && (client_player.direction != Direction::left))
		{
			client_player.direction = Direction::right;
		}
		if ((Keyboard::isKeyPressed(Keyboard::Up)) && (client_player.direction != Direction::down))
		{
			client_player.direction = Direction::up;
		}
		if ((Keyboard::isKeyPressed(Keyboard::Down)) && (client_player.direction != Direction::up))
		{
	...
	{
		std::string dir = "d\n";
		switch (client_player.direction)
		{
		case Direction::left:
			dir = "l\n";
			break;
...
private:
	...
	const std::string raw_ip_address = "192.168.0.101";
